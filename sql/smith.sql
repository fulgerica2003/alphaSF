...
--
-- Host: localhost
-- Generation Time: Dec 22, 2014 at 10:02 AM
...
(1, 'admin', '75ec1c52dee290d2f6ce044256516fc987fabb71', 'a.mocioi@gmail.com', 'horia', 'mocioi', 'english', '', '4874456b0704411f5102c209d5eab6c4', 'yes', 'yes');
...
CREATE TABLE IF NOT EXISTS `ss_pay_orders` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='tabela in care stochez informatiile despre efectuarea platilor' AUTO_INCREMENT=100042 ;
...
(8, '::1', 'horia mocioi', '$2y$08$f2TUInf0FyrXGwFe3kVgiu5wYqtt8kClpBXkZxV/xc1ceZho1XYY2', NULL, 'a.mocioi@gmail.com', NULL, NULL, NULL, '11bMMEBYZ0ujgRUspmeRfe', 1415447144, 1418982368, 1, 'Horia Alexandru', 'Mocioi', 'RO', '0040723276206', '06.12.1962', 'ACCT08', 'SWIFT08', 'Bank Post'),
