...
<div class="input-box">
	...
	<div id="citiesERR" class="eroare<?php echo (form_error('cities')) ? ' afiseaza' : ''; ?>"><a name="AcitiesERR"></a><span id="citiesERRTXT"><?php echo form_error('cities'); ?></span><span class="close-eroare">x</span></div>
</div>