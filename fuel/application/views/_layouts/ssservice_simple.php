	...
	<div class="col-lg-12 col-sm-12">
		<nav class="meniu-interior">
			<div id="box-meniu-interior">
				...
				<?php echo fuel_nav(array('group_id' => 'servicii', 'language' => $lang, 'depth' => 0, 'container_tag_class' => 'lista-nav-big', 'active_class' => 'activ', 'parent' => 'servicii/'.uri_segment(2) . '/' . uri_segment(3), )); ?>
