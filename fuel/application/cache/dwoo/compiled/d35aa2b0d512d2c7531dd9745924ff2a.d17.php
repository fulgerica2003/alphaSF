...
<head>
	<meta charset="utf-8">
	<title><!--__FUEL_MARKER__0-->Stiri - Smith & Smith</title>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
				...
				<div class="language-box">
					<ul id="lista-lang">
						<li><a href="/<!--__FUEL_MARKER__3-->smith/stiri" class="buton-lang active-lang" id="romana">RO</a></li>
						<li><a href="/<!--__FUEL_MARKER__4-->smith/it/stiri" class="buton-lang" id="italiana">IT</a></li>
						<li><a href="/<!--__FUEL_MARKER__5-->smith/sp/stiri" class="buton-lang" id="spaniola">SP</a></li>
						<li><a href="/<!--__FUEL_MARKER__6-->smith/en/stiri" class="buton-lang" id="engleza">EN</a></li>
...
<ul class="nav navbar-nav lista-nav-big">
	<li class="first"><a href="http://localhost/smith/home">HOMEPAGE</a></li>
	<li class="last activ"><a href="http://localhost/smith/stiri">STIRI</a></li>
</ul>
					</div>  
				</div>
			</nav>
	...
	<div id="banner-box">
		<div class="col-lg-12 col-sm-12">
			<div id = "banner-int"><img src="/smith/assets/images/banners/banner-news.jpg" alt="" /></div>			<div class="titlu-pagina"></div>
		</div>
	</div>
	...
	<div id="wrapper">
		<div class="col-lg-9 col-sm-12">
			<div class="caseta page-text">
				<ul class="news-list">
										<li>
						<div class="news-date col-lg-3 col-sm-3">7 November 2014</div>
						<div class="col-lg-9 col-sm-9"><span class="news-exp">Stirea numarul 4</span><a class="news-citeste">Citeste→</a></div>
					</li>
										<li>
						<div class="news-date col-lg-3 col-sm-3">6 November 2014</div>
						<div class="col-lg-9 col-sm-9"><span class="news-exp">Un nou agent SS la Filiasi</span><a class="news-citeste">Citeste→</a></div>
					</li>
										<li>
						<div class="news-date col-lg-3 col-sm-3">6 November 2014</div>
						<div class="col-lg-9 col-sm-9"><span class="news-exp">Program agentii SS</span><a class="news-citeste">Citeste→</a></div>
					</li>
										<li>
						<div class="news-date col-lg-3 col-sm-3">6 November 2014</div>
						<div class="col-lg-9 col-sm-9"><span class="news-exp">E gata caseta de stiri</span><a class="news-citeste">Citeste→</a></div>
					</li>
									</ul>
	...
	<div class="caseta caseta-bkg bkg-brown minimize" id="caseta-online">
		<div class="minimize-caseta">+</div>
		<div class="caseta-titlu"></div>
		<div class="caseta-content">
					</div>
		<a href="<!--__FUEL_MARKER__7--><?php echo site_url('home');?>" class="detail-link"></a>
	</div>
	...
	<div class="col-lg-12 col-sm-12">
		<div class="caseta thin-box">
			...
			<div class="col-lg-6 col-sm-12">
				<div id="footer-right">©2014. Smith&Smith. All rights reserved.</div>
			</div>
			<div class="clearfix"></div>
		</div> 
