 ...
 */
$config['site_title']                 = "Smith";       // Site Title, example.com
$config['admin_email']                = "noreply@smith.com"; // Admin Email, admin@example.com
...
$config['lockout_time']               = 315360000;                 // The number of seconds to lockout an account due to exceeded attempts
