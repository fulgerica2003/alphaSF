...
class Ss_cities_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Ss_city'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('ss_cities'); // table name
	}
...
class Ss_city_model extends Base_module_record {
