...
class Ss_pay_orders_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Ss_pay_order'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('ss_pay_orders'); // table name
	}
...
class Ss_pay_order_model extends Base_module_record {
